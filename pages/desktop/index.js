...
export default class extends React.Component{
    constructor(props = {}){
super(props);
this.state = {objectTagSheet: {},HotTable: null,appDataMap: new Map(),windows: [],d_a: undefined};
...
import('react-mutation-observer').then(m => this.setState({d_a: m}))
}
...
isBrowser = true;
    ...
    let MyMutationObserver = this.props.observer || this.state.d_a?.MutationObserver || (props => props.children);
